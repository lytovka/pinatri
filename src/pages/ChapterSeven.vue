...
<script>
  ...
  import * as inData from '../assets/animations/sevenIn.json';
  import * as constData from '../assets/animations/sevenConst.json';
  import * as outData from '../assets/animations/sevenOut.json';
