...
<script>
  ...
  import * as inData from '../assets/animations/nineIn.json';
  import * as constData from '../assets/animations/nineConst.json';
  import * as outData from '../assets/animations/nineOut.json';
