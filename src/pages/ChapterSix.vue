...
import * as inData from "../assets/animations/sixIn.json";
import * as constData from "../assets/animations/sixConst.json";
import * as outData from "../assets/animations/sixOut.json";
...
export default {
  ...
  beforeRouteLeave(to, from, next) {
    ...
    if (to.name === "StartPage") {
      ...
      this.$store.dispatch("updateLastRoute", "/chapter-six");
    }
  }
};
</script>
