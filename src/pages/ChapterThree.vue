...
import * as inData from "../assets/animations/threeIn.json";
import * as constData from "../assets/animations/threeConst.json";
import * as outData from "../assets/animations/threeOut.json";
...
export default {
  ...
  beforeRouteLeave(to, from, next) {
    ...
    if (to.name === "StartPage") {
      ...
      this.$store.dispatch("updateLastRoute", "/chapter-three");
    } 
  }
};
</script>
