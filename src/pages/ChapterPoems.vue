<template>
  <div>
    ...
    <div class="secondary-svg" :class="`secondary-svg${currentChapter.number}-1`"></div>
    <div class="secondary-svg" :class="`secondary-svg${currentChapter.number}-2`"></div>
    <p id="chapter-title" v-html="currentChapter.name"></p>
  </div>
</template>
