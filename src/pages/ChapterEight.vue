...
import * as inData from "../assets/animations/eightIn.json";
import * as constData from "../assets/animations/eightConst.json";
import * as outData from "../assets/animations/eightOut.json";
